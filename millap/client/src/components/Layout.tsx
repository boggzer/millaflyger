import React, { lazy, Suspense, useContext, CSSProperties } from 'react';
...
const Layout = (): React.ReactElement => {
  ...
  const { full, singles }: Record<'full' | 'singles', ProjectDataType[]> = {
    full: [
      {
        ...
        images: [
          {
            alt: 'Two images of a man, left is clothed and right is half-nude',
            caption: null,
            order: 1,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Four images on a row, with close-ups of a face',
            caption: null,
            order: 1,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt:
              'Diptych with one image of two men facing the same direction, the second image is a mirrored version',
            caption: null,
            order: 1,
            source: [
              {
          ...
          {
            alt: 'Photo of an upper body hugged from behind',
            caption: null,
            order: 2,
            source: [
              {
          ...
          {
            alt:
              'Two images next to each other, left is of a man hugged from behind and right is a nude upper male body',
            caption: null,
            order: 3,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Two images of a woman in a filled bathtub',
            caption: null,
            order: 1,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Four images on a row of two sisters',
            caption: null,
            order: 1,
            source: [
              {
          ...
          {
            alt: 'Four images on a row of two sisters bathing in a lake',
            caption: null,
            order: 2,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt:
              'Diptych of a woman in the foreground in nature, captured in backlight',
            caption: null,
            order: 1,
            source: [
              {
          ...
          {
            alt:
              'Two images next to each other, one of a lake and the other of a woman captured in backlight',
            caption: null,
            order: 3,
            source: [
              {
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Abstract photo of a blended face',
            caption: null,
            order: 1,
            source: [
              {
    ...
    singles: [
      {
        ...
        images: [
          {
            alt:
              'A man with a graphic t-shirt holding a mirror next to his head',
            source: [
              {
                L:
          ...
          {
            alt: 'A half-nude man holding a mirror next to his head',
            source: [
              {
                L:
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Two men in profile facing the same direction',
            source: [
              {
                L: null,
                M:
          ...
          {
            alt:
              'Close-up of two men, one in front of the other and eyes closed, facing the camera',
            source: [
              {
                L: null,
                M:
          ...
          {
            alt: 'Image of an upper body hugged from behind',
            source: [
              {
                L:
          ...
          {
            alt:
              'A man hugging another man from behind with one arm, facing the camera',
            source: [
              {
                L:
      ...
      },
      {
        ...
        images: [
          {
            alt: 'A woman in a filled bathtub',
            source: [
              {
                L:
          ...
          {
            alt: 'A woman in a filled bathtub with her eyes closed',
            source: [
              {
                L:
      ...
      },
      {
        ...
        images: [
          {
            alt: 'Two sisters laying on a rock with closed eyes',
            source: [
              {
                L:
          ...
          {
            alt: 'Two pair of legs, entangled',
            source: [
              {
                L:
          ...
          {
            alt: 'Woman carrying her sister in a lake',
            source: [
              {
                L:
...
*/
  ...
  const WithRef = ({ show, children, match, ...props }: any) => {
          ...
          <Container classes='content'>
            {routes.map(({ path, Component, props }) => (
              <Route key={path} exact path={path}>
                {({ match }) => (
                  <WithRef show={match != null} match={match}>
